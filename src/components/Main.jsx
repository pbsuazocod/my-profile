    ...
    <div className="bg-white">
      ...
      <div className="relative isolate overflow-hidden bg-gradient-to-b from-indigo-100/20 pt-1">
        <div
          ...
          aria-hidden="true"
        />
        <div className="mx-auto px-6 py-32 sm:py-64 lg:px-56 ">
          <div className="mx-auto max-w-2xl lg:mx-0 bg-red-30 lg:max-w-none  lg:gap-x-16 lg:gap-y-6 xl:gap-x-8 flex">
            ...
            <div className="lg:min-w-[50%] ">
              ...
              <p className="mt-[30px] text-2xl font-jost tracking-[0.3px] text-[#929292]">
                I'm not your average Fullstack Developer—I'm also a Civil
                Engineer. Whether you need a stunning website or robust
